...
<body>
    ...
    <div class="benefits pt-5" style="padding-top:20px">
      <div class="flex flex-wrap gap-4 justify-center ">
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 w-full  mt-8 px-4">
    <h2 class="text-2xl font-bold text-gray-800 mb-2 text-center">Member Registration Form</h2>
    <p class="text-sm text-gray-600 mb-6 text-center">
    Please fill in the member registration form below to get the registration form:
    </p>
    <form class="form space-y-4">
      <!-- Nama Perusahaan -->
      <div>
        <label for="nama-perusahaan" class="block text-sm font-medium text-gray-700">Company name</label>
        <input 
          type="text" 
          id="Company name" 
      ...
      <!-- Alamat Perusahaan -->
      <div>
        <label for="alamat-perusahaan" class="block text-sm font-medium text-gray-700">Company's address</label>
        <input 
          type="text" 
      ...
      <!-- Telepon -->
      <div>
        <label for="telepon" class="block text-sm font-medium text-gray-700">Telephone Number</label>
        <input 
          type="tel" 
          id="telepon" 
          class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-[#CBA344] focus:border-[#CBA344]" 
