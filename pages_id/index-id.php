...
<body class="list-none">
  ...
  <!-- Navbar -->
  <div class="lg:flex justify-between items-center px-8 py-2 fixed z-50 w-full bg-white shadow-md lg:h-[7rem]">
      ...
      <div class="flex gap-5 items-center w-full justify-end">
        ...
        <div class="flex space-x-4">
          <a href="../index.php" id="btnEng"
            class="px-6 py-2 text-black bg-gray-200 rounded hover:bg-gray-300 transition">
            ENG
          </a>
          <a href="../pages_id/index-id.php" id="btnIdn"
            class="px-6 py-2 text-white bg-[#B3943C] rounded hover:bg-[#B3943C] transition">
            IDN
          </a>
        </div>
        <button class="text-white px-5 py-2 rounded-md" style="background-color: #CBA344;">Bergabung</button>
      </div>
      <div class="flex items-center gap-9 py-3">
        <a href="index-id.php" class="nav-link">Beranda</a>

        <!-- Dropdown for Membership -->
        <div class="relative group">
          <a id="membershipLink" class="nav-link flex items-center gap-2 cursor-pointer">Keanggotaan <svg
          ...
          <div id="membershipDrop"
            ...
            style="width: 13rem;">
            <a href="list_anggota.php" class="block px-4 py-2 hover:bg-gray-200 transition"> List Anggota APJATI</a>
            <a href="daftar_apjapti.php" class="block px-4 py-2 hover:bg-gray-200 transition">Daftar Anggota</a>
          </div>
        </div>
        <!-- media -->
        <div class="relative group">
          ...
          <div id="mediaDrop"
            class="absolute left-1/2 transform -translate-x-1/2 hidden bg-white text-black shadow-lg transition duration-300 ease-in-out rounded-md mt-2"
            style="width: 13rem;">
            <a href="media.php" class="block px-4 py-2 hover:bg-gray-200 transition">Publikasi</a>
            <a href="#" class="block px-4 py-2 hover:bg-gray-200 transition">Gallery</a>
          </div>
        </div>

        <a href="regulasi.php" class="nav-link">Regulasi</a>

        <!-- Dropdown for About Us -->
        <div class="relative group">
          <a id="aboutLink" class="nav-link flex items-center gap-2 cursor-pointer">Tentang Kami<svg
              xmlns="http://www.w3.org/2000/svg" width="20" height="25" viewBox="0 0 1024 1024">
              <path fill="currentColor"
                d="M831.872 340.864L512 652.672L192.128 340.864a30.59 30.59 0 0 0-42.752 0a29.12 29.12 0 0 0 0 41.6L489.664 714.24a32 32 0 0 0 44.672 0l340.288-331.712a29.12 29.12 0 0 0 0-41.728a30.59 30.59 0 0 0-42.752 0z" />
            </svg></a>
          <div id="aboutDrop"
            class="absolute left-1/2 transform -translate-x-1/2 hidden bg-white text-black shadow-lg transition duration-300 ease-in-out rounded-md mt-2"
            style="width: 14rem;">
            <a href="about_us.php" class="block px-4 py-2 hover:bg-gray-200 transition">Tentang APJATI</a>
            <a href="department.php" class="block px-4 py-2 hover:bg-gray-200 transition">Department APJATI </a>
          </div>
        </div>

        <a href="contact_us.php" class="nav-link">Kontak Kami</a>
    ...
    <div id="menu-mobile"
      ...
      <div class="flex space-x-4">
        <a href="../index.php" id="btnEng"
          class="px-2 py-2 text-sm text-black bg-gray-200 rounded hover:bg-gray-300 transition ">
          ENG
        </a>
        <a href="../pages_id/index-id.php" id="btnIdn"
          class="px-2 py-2 text-sm text-white bg-[#B3943C] rounded hover:bg-[#B3943C] transition">
          IDN
        </a>
      </div>
      ...
      <a href="index-id.php" class="text-gray-800 hover:bg-gray-200 my-2 rounded-md flex"
        style="width: 100%;">Beranda</a>
      ...
      <div class="relative w-full lg:w-auto">
        ...
        <div id="membership-menu" class="dropdown-menu bg-white rounded-md pt-2 hidden">
          <a href="list_anggota.php" class="block px-4 py-1 hover:bg-gray-200">List Anggota APJATI</a>
          <a href="daftar_apjapti.php" class="block px-4 py-1 hover:bg-gray-200">Daftar Anggota</a>
        </div>
      </div>
      ...
      <div class="relative w-full lg:w-auto">
        ...
        <div id="media-menu" class="dropdown-menu bg-white rounded-md mt-2 hidden">
          <a href="about_us.php" class="block px-4 py-2 hover:bg-gray-200">Publikasi</a>
          <a href="department.php" class="block px-4 py-2 hover:bg-gray-200">Galeri</a>
        </div>
      </div>

      <!-- Regulation Link -->
      <a href="regulasi.php" class="text-gray-800 hover:bg-gray-200 my-2 flex rounded-md">Regulasi</a>
      ...
      <div class="relative w-full lg:w-auto">
        ...
        <div id="aboutus-menu" class="dropdown-menu bg-white rounded-md mt-2 hidden">
          <a href="about_us.php" class="block px-4 py-2 hover:bg-gray-200">Tentang APJATI</a>
          <a href="department.php" class="block px-4 py-2 hover:bg-gray-200">Departemen APJATI</a>
        </div>
      </div>

      <!-- Contact Us -->
      <a href="contact_us.php" class="text-gray-800 hover:bg-gray-200 my-2 flex rounded-md">Kontak Kami</a>
  ...
  <section class="carousel">
    <section class="carousel pt-[4rem] lg:pt-0">
      ...
      <div class="carousel-text absolute inset-0 flex items-center justify-center pt-[4rem] lg:pt-0">
        <h2 class="text-white text-base px-4 text-center font-bold lg:text-[3rem] lg:px-0">Assosiasi Perusahaan Jasa Tenaga Kerja Indonesia</h2>
      </div>
      <button id="prev"
    ...
    <section class="py-16 flex flex-col items-center justify-center overflow-hidden">
      <h1 class="lg:mb-8 lg:text-4xl text-2xl font-bold ">
        TESTIMONI
      </h1>
      <div>
        <div class="splide ">
            ...
            <ul class="splide__list">
                ...
                <div class="flex rounded-lg h-full bg-white  shadow-lg p-8 flex-col">
                  ...
                  <div class="flex flex-col justify-center flex-grow">
                    <p class="leading-relaxed text-center text-base text-gray-700 ">
                      "Kementerian, badan, perusahan swasta ternasuk Apjati harus menjadi bagian perubahan besar yang kita
                      lakukan"
                    </p>
                  </div>
                </div>
              ...
              <li class="splide__slide p-4 max-w-sm lg:max-w-lg">
                <div class="flex rounded-lg h-full bg-white  shadow-lg p-8 flex-col">
                  ...
                  <div class="flex flex-col justify-center flex-grow">
                    <p class="leading-relaxed text-center text-base text-gray-700 ">
                      "Apresiasi yang luar biasa terhadap Rakernas ini telah memberikan semangat luar biasa yang telah
                      menjadikan duta wisata dan bela negara."
                    </p>
                  </div>
                </div>
              </li>
                ...
                <div class="flex rounded-lg h-full bg-white  shadow-lg p-8 flex-col">
                  <div class="flex items-center mb-3">
                    <div class="flex flex-col items-center justify-center gap-2 w-full">
                      ...
                      <h2 class="text-gray-600 dark:text-gray-400 text-sm font-normal">
                        Menteri Koordinator Bidang Pemberdayaan Masyarakat Republik Indonesia
                      </h2>
                    </div>
                  </div>
                  <div class="flex flex-col justify-center flex-grow">
                    <p class="leading-relaxed text-center text-base text-gray-700 ">
                      "Pengakuan atas Apjati juga sebagai apresiasi atas organisasi yang memiliki sejarah panjang, selalu
                      bermitra dengan pemerintah dan merupakan asosiasi pertama serta menjadi "bapak" bagi organisasi
                      lain."
                    </p>
                  </div>
                </div>
                ...
                <div class="flex rounded-lg h-full bg-white  shadow-lg p-8 flex-col">
                  <div class="flex items-center mb-3">
                    <div class="flex flex-col items-center justify-center gap-2 w-full">
                      ...
                      <h2 class="text-gray-600 dark:text-gray-400 text-sm font-normal">
                        Mentri Perlindungan Pekerja Migran Indonesia
                      </h2>
                    </div>
                  </div>
                  <div class="flex flex-col justify-center flex-grow">
                    <p class="leading-relaxed text-center text-base text-gray-700 ">
                      "Kami mendukung penuh program kerja Apjati yang tidak hanya meringankan tugas pemerintah, tetapi
                      juga memberikan dampak positif bagi pelindungan PMI dan optimalisasi penempatan tenaga kerja
    ...
    <div id="stats-section" class="py-7 lg:h-72 flex flex-col items-center justify-center"
      ...
      <div class="flex lg:gap-11 gap-5 flex-col lg:flex-row mt-8 lg:mt-7 items-center justify-center">
        <div class="data3 flex flex-col items-center lg:border-r-2 lg:border-black lg:pr-8 lg:w-[290px] w-44 text-center">
          ...
          <p class="font-medium">Perwakilan Daerah (DPD)</p>
        </div>
        <div
          ...
          <p class="font-medium">Jumlah PMI</p>
        </div>
        <div
          ...
          <p class="font-medium">Dari 1982</p>
        </div>
        <div
          ...
          <p class="font-medium">Anggota Agensi</p>
        </div>
        <div class="data5 flex flex-col items-center border-black pt-8 lg:pt-0 lg:border-t-0">
          ...
          <p class="font-medium">Negara tujuan</p>
        </div>
      </div>
    </div>
    ...
    <main class="py-16 px-8 bg-white">
      <div class="container mx-auto">
        <div class="flex justify-between items-center">
          ...
          <a href="media.php" class="text-sm lg:text-lg font-medium text-blue-400 flex items-center gap-2 cursor-pointer hover-animate">
            Selengkapnya
      ...
      <div class="mt-10 flex flex-wrap gap-8 justify-center items-start">
        <div class="flex flex-col w-[300px]">
          ...
          <h1 class="text-lg leading-6 font-semibold pt-3">
            Penghargaan kepada Ayub Basalamah, mantan Ketua APJATI, atas pengabdiannya selama 12 tahun
          </h1>
        ...
        <div class="flex flex-col w-[300px]">
          ...
          <h1 class="text-lg leading-6 font-semibold pt-3">
            Pertemuan antara Menteri P2MI dan APJATI bertujuan untuk memperkuat sinergi.
          </h1>
          <p class="flex items-center pt-3 gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <path fill="currentColor"
        ...
        <div class="flex flex-col w-[300px]">
          ...
          <h1 class="text-lg leading-6 font-semibold pt-3">
            Pertemuan Kamar Dagang Indonesia (KADIN) dengan APJATI, berdiskusi
            perluasan pasar kerja global.
          </h1>
          <p class="flex items-center pt-3 gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <path fill="currentColor"
    ...
    <main class="py-16 px-8 bg-white">
      <div class="container mx-auto">
        <div class="flex justify-between items-center mb-5">
          <h2 class="text-xl font-bold border-black text-left w-[12rem] lg:w-[16rem] lg:text-4xl">
            PHOTO ALBUM
          </h2>
          <a class="lg:text-lg text-sm font-medium text-blue-400 flex items-center gap-2 cursor-pointer hover-animate">
            Selengkapnya
            <svg xmlns="http://www.w3.org/2000/svg" width="12" height="24" viewBox="0 0 12 24">
              <defs>
                <path id="weuiArrowOutlined0" fill="currentColor"
    ...
    <!-- footer -->
    <footer class="text-black bg-[#CBA344] mt-20">
      <div class="container mx-auto px-6 py-8 flex flex-col justify-center">
        ...
        <div class="flex flex-col lg:flex-row justify-center items-start gap-6">
          ...
          <div class="w-full md:w-1/3">
            <h1 class="font-semibold text-xl mb-4">KANTOR APJATI</h1>
            <div class="space-y-4">
          ...
          <div class="flex gap-3 lg:gap-5">
            ...
            <div class="">
              ...
              <ul class="space-y-2 text-sm">
                ...
                <li><a href="daftar_apjapti.php" class="hover:underline">Membership APJATI</a></li>
                <li><a href="regulasi.php" class="hover:underline">Regulation</a></li>
                <li><a href="about_us.php" class="hover:underline">About Us</a></li>
            ...
            <div class="">
              ...
              <ul class="space-y-2 text-sm">
                <li><a href="list_anggota.php" class="hover:underline">Member List</a></li>
                <li><a href="list_anggota.php" class="hover:underline">Member Registration</a></li>
              </ul>
            </div>
          </div>
          <div class="flex gap-3 lg:gap-5">
            ...
            <div class="">
              ...
              <ul class="space-y-2 text-sm">
                <li><a href="about_us.php" class="hover:underline">About Us APJATI</a></li>
                <li>
                  <a href="department.php" class="hover:underline">Structure APJATI</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="">
            ...
            <ul class="space-y-2 text-sm">
              ...
              <li><a href="https://www.instagram.com/apjati.id?igsh=OGJqYW0yaGJuZ3J2" class="hover:underline">Instagram</a></li>
    ...
    <script src="../src/js/button-language.js"></script>
