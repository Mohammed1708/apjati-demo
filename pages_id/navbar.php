    ...
    <div id="menu-dekstop" class="hidden lg:flex lg:flex-col  items-center mt-4 lg:mt-0 bg-white flex flex-col">
      <div class="flex gap-5 items-center w-full justify-end">
        ...
        <div class="flex space-x-4">
          <a href="../index.php" id="btnEng" 
             class="px-6 py-2 text-black bg-gray-200 rounded rounded hover:bg-[#B3943C] transition">
            ENG
          </a>
          <a href="../pages_id/index-id.php" id="btnIdn" 
             class="px-6 py-2  text-white bg-[#B3943C] hover:bg-gray-300 transition">
            IDN
          </a>
        </div>

        <button class="text-white px-5 py-2 rounded-md" style="background-color: #CBA344;">Gabung</button>
      </div>
      <div class="flex items-center gap-9 py-3">
        ...
        <div class="relative group">
          <a id="membershipLink" class="nav-link flex items-center gap-2 cursor-pointer">Anggota <svg
          ...
          <div id="membershipDrop"
            ...
            <a href="daftar_apjapti.php" class="block px-4 py-2 hover:bg-gray-200 transition">Registrasi Anggota</a>
          </div>
        </div>
        <!-- media -->
        <div class="relative group">
          ...
          <div id="mediaDrop"
            ...
            <a href="#" class="block px-4 py-2 hover:bg-gray-200 transition">Galeri</a>
          </div>
        </div>
        ...
        <div class="relative group">
          ...
          <div id="aboutDrop"
            ...
            <a href="department.php" class="block px-4 py-2 hover:bg-gray-200 transition">Departemen APJATI </a>
          </div>
        </div>
    ...
    <div id="menu-mobile"
      ...
      <div class="relative w-full lg:w-auto">
        ...
        <div id="membership-menu" class="dropdown-menu bg-white rounded-md pt-2 hidden">
          <a href="list_anggota.php" class="block px-4 py-1 hover:bg-gray-200">Anggota APJATI</a>
          <a href="daftar_apjapti.php" class="block px-4 py-1 hover:bg-gray-200">Registrasi Anggota</a>
        </div>
      </div>
      ...
      <div class="relative w-full lg:w-auto">
        ...
        <div id="media-menu" class="dropdown-menu bg-white rounded-md mt-2 hidden">
          <a href="about_us.php" class="block px-4 py-2 hover:bg-gray-200">Galeri</a>
          <a href="department.php" class="block px-4 py-2 hover:bg-gray-200">Publikasi</a>
        </div>
      </div>
      ...
      <!-- Social Media Icons -->
      <button class="w-full bg-[#CBA344] text-white text-sm py-2 h-9 rounded-md lg:w-auto lg:text-base">
        Gabung
      </button>
